 ...
 * limitations under the License.
 */
e(u)(e(c).mark((function t(r,n){return e(c).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Ue(r,"POST","/v1/accounts:signInWithEmailLink",Ae(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Ht(e,t){return Wt.apply(this,arguments)}function Wt(){return(Wt=e(u)(e(c).mark((function t(r,n){return e(c).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Ue(r,"POST","/v1/accounts:signInWithEmailLink",Ae(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var qn=new Se(3e4,6e4);function Hn(){var t=Vr().___jsl,r=!0,n=!1,i=void 0;if(null==t?void 0:t.H)try{for(var a,s=Object.keys(t.H)[Symbol.iterator]();!(r=(a=s.next()).done);r=!0){var o=a.value;if(t.H[o].r=t.H[o].r||[],t.H[o].L=t.H[o].L||[],t.H[o].r=e(ee)(t.H[o].L),t.CP)for(var u=0;u<t.CP.length;u++)t.CP[u]=null}}catch(e){n=!0,i=e}finally{try{r||null==s.return||s.return()}finally{if(n)throw i}}}var Wn=null;function zn(e){return Wn=Wn||function(e){return new Promise((function(t,r){var n,i,a;function s(){Hn(),gapi.load("gapi.iframes",{callback:function(){t(gapi.iframes.getContext())},ontimeout:function(){Hn(),r(pe(e,"network-request-failed"))},timeout:qn.get()})}if(null===(i=null===(n=Vr().gapi)||void 0===n?void 0:n.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=Vr().gapi)||void 0===a?void 0:a.load)){var o=on("iframefcb");return Vr()[o]=function(){gapi.load?s():r(pe(e,"network-request-failed"))},sn("https://apis.google.com/js/api.js?onload=".concat(o)).catch((function(e){return r(e)}))}s()}})).catch((function(e){throw Wn=null,e}))}(e),Wn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(hi)),(0,ne.registerVersion)(di,fi,"esm2017");var yi=i("88RRX"),bi=i("da801");H=i("4Nugj"),N=i("iU1Pc");(0,bi.initFireBase)();var wi,_i,Ii,xi,Ti=(0,yi.getFirestore)(),Si=ki(),Ei=new sr;wi=Si,_i=function(e){e?(H.refs.modal.classList.add("is-hidden"),H.refs.body.classList.remove("no-scroll"),H.refs.openModalAuthBtn.innerHTML="<span>SIGN OUT</span>",H.refs.sigInGoogleBtn.classList.add("is-hidden"),H.refs.userInfo.innerHTML="\n              <span>".concat(e.email,"</span>\n            "),H.refs.myLibLink.classList.remove("visually-hidden"),localStorage.setItem("UserID",e.uid)):(H.refs.openModalAuthBtn.innerHTML="<span>SIGN IN</span>",H.refs.sigInGoogleBtn.classList.remove("is-hidden"),H.refs.userInfo.innerHTML="",H.refs.myLibLink.classList.add("visually-hidden"),localStorage.setItem("UserID","DefaultUser"))},(0,re.getModularInstance)(wi).onAuthStateChanged(_i,Ii,xi),H.refs.loginForm.addEventListener("submit",(function(t){t.preventDefault();var r=t.target,n=t.target[0].value.trim(),i=t.target[1].value.trim();Tr(Si,n,i).then((function(t){var r=t.user;e(N).Notify.success("Signin with ".concat(r.email," successful"))})).catch((function(t){e(N).Notify.failure("Sign-in  error happened")})),r.reset()})),H.refs.registerForm.addEventListener("submit",(function(t){t.preventDefault();var r=t.target[0].value.trim(),n=t.target[1].value.trim(),i=t.target;Ir(Si,r,n).then((function(t){var r=t.user;e(N).Notify.success("User Created with email:".concat(r.email)),(0,yi.setDoc)((0,yi.doc)(Ti,r.uid,"00000001"),{Queue:[],Watched:[]}),localStorage.setItem("UserID",r.uid)})).catch((function(t){e(N).Notify.failure("User no created")})),i.reset()})),H.refs.sigInGoogleBtn.addEventListener("click",(function(){var t=null;bn(Si,Ei).then((function(r){var n=r.user;e(N).Notify.success("Sign-in with ".concat(n.email," successful")),t=r.user.uid,(0,yi.getDocs)((0,yi.collection)(Ti,t)).then((function(e){e.docs[0]?console.log("Nice to see you again"):(0,yi.setDoc)((0,yi.doc)(Ti,t,"00000001"),{Queue:[],Watched:[]})}))})).catch((function(t){e(N).Notify.failure("Sign-in with Google account error happened")}))})),H.refs.openModalAuthBtn.addEventListener("click",(function(){return"<span>SIGN OUT</span>"===H.refs.openModalAuthBtn.innerHTML?Rr(Si).then((function(){})).catch((function(e){})):void 0}));u=i("bpxeT"),c=i("2TvXO"),bi=i("da801"),yi=i("88RRX");i("4Nugj");(0,bi.initDataBase)(),ki()}();
//# sourceMappingURL=index.d56c11c7.js.map
